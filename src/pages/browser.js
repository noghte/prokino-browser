        ...
        return(
            <Layout>
              ...
              <div className="row justify-content-center">
                ...
                <h4 className="box-item-title pb-3 mbr-fonts-style align-center fs-4">Quick Search</h4>
              ...
              <Link style={{color:'#000', textDecoration:'none'}} to="/queries">
                  <h4 className="box-item-title pb-3 mbr-fonts-style align-center fs-4">Advanced Queries</h4>
                  </Link>
              ...
              <div className="box-item col-md-4">
                ...
                <h4 className="box-item-title pb-3 mbr-fonts-style align-center fs-4">Browse</h4>
