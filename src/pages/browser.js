        ...
        return(
            <Layout>
              ...
              <div className="row justify-content-center">
                ...
                <h4 className="box-item-title pb-3 mbr-fonts-style align-center display-8">Quick Search</h4>
              ...
              <div className="box-item col-md-4">
                  ...
                  <h4 className="box-item-title pb-3 mbr-fonts-style align-center display-8">
                    {/* <Link style={{color:'#000', textDecoration:'none'}} to="/queries">Queries</Link> */}
                    <a href="/queries">Queries</a>
                    </h4>
          
                  <p className="box-item-text mbr-fonts-style align-center display-7">3Build your own SPARQL queries based on examples, or from scratch.</p>
              </div>
              <div className="box-item col-md-4">
                <div className="icon-block-top pb-4 align-center">
                ...
                <h4 className="box-item-title pb-3 mbr-fonts-style align-center display-8">Browse</h4>
