        ...
        <div className="row justify-content-center">
          <div className="box-bordered box-item col-md-3">
            ...
            <h4 className="box-item-title pb-3 mbr-fonts-style align-center display-8">
              <Link style={{fontWeight: 'bold', color:'#000'}} to="/browser">Search</Link>
          ...
          <div className="box-bordered box-item col-md-3">
            ...
            <h4 className="box-item-title pb-3 mbr-fonts-style align-center display-8">
              <Link style={{fontWeight: 'bold', color:'#000'}} to="/queries">Queries</Link>
            </h4>
          ...
          <div className="box-bordered box-item col-md-3">
            ...
            <h4 className="box-item-title pb-3 mbr-fonts-style align-center display-8">
              <Link style={{fontWeight: 'bold', color:'#000'}} to="/browse-data">Browse Data</Link>
            </h4>
